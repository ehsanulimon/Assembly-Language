.MODEL SMALL
 ...
 .DATA
   ...
   Msg3   DB  'The given capital letters in alphabetical order are : $'
 ...
 .CODE
   MAIN PROC
     ...
     LEA DX, Msg1             ; load and display the string PROMPT_1
     INT 21H
     ...
     LEA DX, Msg2             ; load and display the string PROMPT_2
     INT 21H
     ...
     LEA DX, Msg3             ; load and display the string PROMPT_3
     INT 21H
